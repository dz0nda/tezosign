DROP DATABASE IF EXISTS tzkt_db;

CREATE USER tzkt_admin PASSWORD 'tzkt_admin';

CREATE DATABASE tzkt_db;

GRANT ALL PRIVILEGES ON DATABASE tzkt_db TO tzkt_admin;

\c tzkt_db tzkt_admin;
